...
//gn1 , gexpo1 y gx1 son los parametros que ingresan desde afuera
    ...
    public String Integral1(double num2, double num3,  int expo1, int expo2, int expo3){
        //gn1 , gexpo1 y gx1 son los parametros que ingresan desde afuera
        //Prueba con un solo termino
        //Si no se especific la variable y el exponente, se suponen como 1
        String phrase1 = null;
        ...
        phrase1 = (String.valueOf(num2) + "X^" + String.valueOf(expo2)+" + "+String.valueOf(num3) + "X^" + String.valueOf(expo3)+" + C");
        System.out.println(phrase1);
        return phrase1;
    }
    public String Integral2(double num2, double num3,  int expo1, int expo2, int expo3){
        int n=0;
        int n1=0;
        String phrase1 = null;
//gn1 , gexpo1 y gx1 son los parametros que ingresan desde afuera
